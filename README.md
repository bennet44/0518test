...
- **價格、技術指標與基本面**（單一股票）：K 線圖、SMA20/50、布林通道、RSI、MACD、成交量，與該股票的基本面財務（P/E、P/B、EPS、營收/盈餘成長率、ROE、淨利率、股息率），分頁內輸入股票代號即可連動更新（預設 AAPL）
...
- **買賣建議**：篩選範圍為「美股交易量前 30 大（觀察名單）」與「S&P 500 成分股」的聯集，以基金經理人角度綜合期間報酬率、Sharpe Ratio、價格趨勢、估值水準計算評分，列出建議買入／賣出的前 N 項（N 可選 1/5/10/15，預設 5），並估算買入價／賣出價（假設 3~5% 價格波動）
