...
- **價格與技術指標**：K 線圖、SMA20/50、布林通道、RSI、MACD、成交量
- **基本面財務**：P/E、P/B、EPS、營收/盈餘成長率、ROE、淨利率、股息率等多股票比較
- **多股比較與關聯**：累積報酬比較、日報酬相關係數矩陣（熱力圖）
- **風險與統計**：年化報酬率、年化波動率、Sharpe Ratio、最大回撤、VaR、日報酬分布
- **買賣建議**：以基金經理人角度，綜合期間報酬率、Sharpe Ratio、價格趨勢、估值水準計算評分，列出清單中建議買入／賣出的前 N 項（N 可選 1/5/10/15，預設 10）
